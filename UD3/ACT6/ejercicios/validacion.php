...
<body class="d-flex flex-column h-100">
    ...
    <!-- Begin page content -->
    <main class="flex-shrink-0 mt-4 d-flex justify-content-center">

        <?php
        // Valores correctos definidos
        $usuario1= "imaw";
        $clave1 = "1234";
        ...
        // Validación
        //con === a parte de comprabar que el dato sea el mismo también se comprueba que sea del mismo tipo
        
        if ($usuario === $usuario1 && $clave === $clave1) {
            echo '<div class="p-4 bg-white rounded shadow-sm text-center" style="max-width: 400px;">';
            echo "<p><strog>Datos correctos. </p><p></strong>Bienvenido, <span class='text-primary fw-bold'> $usuario</p>";

            //aqui se hace una linea de formulario donde clicas en volver y puedes reintentar la conexión
            echo '<form action="ejercicio5.php" method="get" class="p-3 bg-white rounded shadow-sm" style="max-width: 400px;">
            ...
            echo '<div class="p-4 bg-white rounded shadow-sm text-center" style="max-width: 400px;">';
            echo '<p class="text-danger"><strong>Algún dato introducido no es correcto.</strong></p><p> Vuelve a la página de login e inténtalo de nuevo.</p>';
